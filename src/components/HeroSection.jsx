...
const HeroSection = ({ scrollY }) => {
    ...
    // Обчислюємо прозорість: тепер ділимо на 1000 для більш плавного зникнення
    const opacity = Math.max(0, 1 - scrollY / 1000);
    // Додаємо легке розмиття при скролі (максимум 8px)
    ...
    return (
        ...
        >
            ...
            {/* Основний контент із паралакс-ефектом */}
